...
public class FooterFragment extends Fragment {
    ...
    private OnFooterFragmentListener mListener;
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mListener = (OnFooterFragmentListener) activity;
        } catch (ClassCastException e) {
            throw new ClassCastException(activity.toString()
                    + " must implement OnFooterFragmentListener");
        }
    }
     ...
     */
    public interface OnFooterFragmentListener {
